...
import 'home_data_table_model.dart';
...
class HomeDataTableWidget extends StatefulWidget {
  ...
  static String routeName = 'HomeDataTable';
  static String routePath = '/homeDataTable';

  @override
  State<HomeDataTableWidget> createState() => _HomeDataTableWidgetState();
}

class _HomeDataTableWidgetState extends State<HomeDataTableWidget> {
  late HomeDataTableModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeDataTableModel());

    _model.vp1DcTextController ??= TextEditingController();
    _model.vp1DcFocusNode ??= FocusNode();

    _model.vp2LibreTextController ??= TextEditingController();
    _model.vp2LibreFocusNode ??= FocusNode();

    _model.vp3PinuTextController ??= TextEditingController();
    _model.vp3PinuFocusNode ??= FocusNode();

    _model.vp4LibTextController ??= TextEditingController();
    _model.vp4LibFocusNode ??= FocusNode();

    _model.vp5NacTextController ??= TextEditingController();
    _model.vp5NacFocusNode ??= FocusNode();

    _model.vp7BlancosTextController ??= TextEditingController();
    _model.vp7BlancosFocusNode ??= FocusNode();

    _model.vp6NulosTextController ??= TextEditingController();
    _model.vp6NulosFocusNode ??= FocusNode();
  }
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          focusNode: _model.vp7BlancosFocusNode,
                              ...
                              child: Row(
                                ...
                                children: [
                                  FFButtonWidget(
                                    ...
                                    text: 'Enviar Resultados de Acta',
                                    options: FFButtonOptions(
                                      height: 40.0,
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                        16.0,
                                            ...
                                            if (selectedMedia != null &&
                                              ...
                                              if (selectedUploadedFiles
                                                  ...
                                                  downloadUrls.length ==
                                                      selectedMedia.length) {
                                                safeSetState(() {
                                                  _model.uploadedLocalFile_uploadDataO0t =
                                                      selectedUploadedFiles
                                                          .first;
                                                  _model.uploadedFileUrl_uploadDataO0t =
                                                      downloadUrls.first;
